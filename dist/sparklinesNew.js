(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["sparklinesNew"] = factory();
	else
		root["sparklinesNew"] = factory();
})(window, function() {
...
// CONCATENATED MODULE: ./src/integration/sparklines/sparklinesNew.js
...
looker.plugins.visualizations.add({
  ...
  updateAsync: function updateAsync(data, element, config, queryResponse, details, done) {
    ...
    if (typeof config.where_values == 'undefined' || typeof config.where_chart == 'undefined') {
      jquery('#vis').contents(':not(style)').remove();
      ...
      try {
        ...
        var createTable = function createTable(data_insert, element) {
          ...
          jquery["each"](headings_dim, function () {
            var found = false;
          ...
          html += '</tbody>';
          html += '</table>';
          jquery("#vis").append(html);

          if (config.freeze_header == true) {
            jquery('th').addClass('stuck');
          } else {
            jquery('th').removeClass('stuck');
          }

          if (config.text_directionality == false) {
            jquery('.value-down').addClass('color-off');
            jquery('.value-up').addClass('color-off');
          } else {
            jquery('.value-down').removeClass('color-off');
            jquery('.value-up').removeClass('color-off');
          }
        ...
        var drawOnTable = function drawOnTable(data_insert, element) {
          if (config.size_to_fit == true) {
            jquery("table").addClass("size-to-fit");
          } else {
            jquery("table").removeClass("size-to-fit");
          }
