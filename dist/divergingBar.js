(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["divergingBar"] = factory();
	else
		root["divergingBar"] = factory();
})(window, function() {
...
/* harmony import */ var d3_collection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17);
...
looker.plugins.visualizations.add({
  ...
  updateAsync: function updateAsync(data, element, config, queryResponse, details, done) {
    ...
    if (environment == "prod") {
      if (!Object(_common_utils__WEBPACK_IMPORTED_MODULE_3__[/* handleErrors */ "a"])(this, queryResponse, {
        min_pivots: 0,
        max_pivots: 0,
        min_dimensions: 0,
        max_dimensions: 22,
    ...
    try {
      ...
      var mousemove = function mousemove(d) {
        var subgroupNameNumber = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "l"](this.parentNode).datum().key;
        ...
        tooltipBody.html("<span style=\"float:left;\">".concat(measureName, ":&nbsp&nbsp</span>") + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](config.x_format)(subgroupValue * valueSign), "</span><br>") + "<span style=\"float:left;\">% of Total:&nbsp&nbsp</span>" + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](",.1%")(subgroupValue / d.data[totalKey]), "</span>"));
        ...
        if (totalKey == "rightTot" && config.right_hovers) {
          ...
          rightHovers.forEach(function (d, i) {
            var tmp = "<br><span style=\"float:left;\">".concat(measures[d].label_short, ":&nbsp&nbsp</span>") + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](",.0f")(data_row[0][measures[d].name].value), "</span>");
        ...
        if (totalKey == "leftTot" && config.left_hovers) {
          ...
          leftHovers.forEach(function (d, i) {
            var tmp = "<br><span style=\"float:left;\">".concat(measures[d].label_short, ":&nbsp&nbsp</span>") + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](",.0f")(_data_row[0][measures[d].name].value), "</span>");
            left_add = left_add + tmp;
          });
          tooltipBody.html(tooltipBody.html() + left_add);
        }

        if (d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageY < boundedHeight * 0.7) {
          tooltip.style("top", d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageY - 40 + "px");
        } else {
          tooltip.style("top", d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageY - 150 + "px");
        }

        if (d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageX < boundedWidth * 0.7) {
          tooltip.style("left", d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageX + 20 + "px");
        } else {
          tooltip.style("left", d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageX - 170 + "px");
        }
      };
      ...
      var svg = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "l"](element).select("svg").html('').attr('width', '100%').attr('height', '100%');
      ...
      var rightStacked = d3__WEBPACK_IMPORTED_MODULE_0__[/* stack */ "m"]().keys(rightSubgroups)(data_right);
      var leftStacked = d3__WEBPACK_IMPORTED_MODULE_0__[/* stack */ "m"]().keys(leftSubgroups)(data_left);
      ...
      var yScale = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleBand */ "j"]() // .domain(data_ready.map(d => labelAccessor(d)))
      .domain(yValuesOrdered).range([boundedHeight, 0]).padding(0.2);
      var yAxisGenerator = d3__WEBPACK_IMPORTED_MODULE_0__[/* axisLeft */ "b"]().scale(yScale).tickPadding(10).tickSize(0); // .tickFormat((d) => `${d}`)

      var xScaleDomain = [d3__WEBPACK_IMPORTED_MODULE_0__[/* min */ "i"](data_left.map(function (d) {
        return d.leftTot;
      })), d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "h"](data_right.map(function (d) {
        return d.rightTot;
      }))];
      var xScale = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleLinear */ "k"]().domain(xScaleDomain).range([0, boundedWidth]);
      var xAxisGenerator = d3__WEBPACK_IMPORTED_MODULE_0__[/* axisBottom */ "a"]().scale(xScale).tickPadding(10).tickSizeOuter(0) // .tickSizeInner(5)
      .tickSizeInner(-boundedHeight);

      if (config.left_negative == false) {
        xAxisGenerator.tickFormat(function (d) {
          return d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](config.x_format)(Math.abs(d));
        });
      } else {
        xAxisGenerator.tickFormat(function (d) {
          return d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](config.x_format)(d);
        });
      }
      ...
      var barsLeft = group.append("g").selectAll("g").data(leftStacked).enter().append("g").attr("fill", function (e, i) {
        if (i == 0) {
          var color = d3__WEBPACK_IMPORTED_MODULE_0__[/* interpolateOranges */ "f"](.5);
          left_colors.push(color);
          return color;
        } else {
          var _color = d3__WEBPACK_IMPORTED_MODULE_0__[/* interpolateOranges */ "f"](left_color_divider * i + 0.5);
      ...
      var barsRight = group.append("g").selectAll("g").data(rightStacked).enter().append("g").attr("fill", function (e, i) {
        if (i == 0) {
          var color = d3__WEBPACK_IMPORTED_MODULE_0__[/* interpolateBlues */ "e"](.5);
          right_colors.push(color);
          return color;
        } else {
          var _color2 = d3__WEBPACK_IMPORTED_MODULE_0__[/* interpolateBlues */ "e"](right_color_divider * i + 0.5);
      ...
      var xAxisLabel = xAxis.append("text").attr("class", "axis-label").attr("x", xScale(0)).attr("y", margin.bottom - 8).style("text-anchor", "middle").text(config.x_label); // LEGEND --------------------------------------------------
      ...
      var legendRows = [d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "l"]('.legend-0'), d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "l"]('.legend-1'), d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "l"]('.legend-2')];
      var rowNum = 0;
