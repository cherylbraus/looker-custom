(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["monthlyGoals"] = factory();
	else
		root["monthlyGoals"] = factory();
})(window, function() {
...
/* concated harmony reexport max */__webpack_require__.d(__webpack_exports__, "f", function() { return src_max; });
...
/* concated harmony reexport json */__webpack_require__.d(__webpack_exports__, "e", function() { return json; });
...
/* concated harmony reexport scaleBand */__webpack_require__.d(__webpack_exports__, "h", function() { return band; });
/* unused concated harmony import scalePoint */
/* unused concated harmony import scaleIdentity */
/* concated harmony reexport scaleLinear */__webpack_require__.d(__webpack_exports__, "i", function() { return linear_linear; });
...
/* concated harmony reexport mouse */__webpack_require__.d(__webpack_exports__, "g", function() { return mouse; });
...
/* concated harmony reexport select */__webpack_require__.d(__webpack_exports__, "j", function() { return src_select; });
...
/* concated harmony reexport stack */__webpack_require__.d(__webpack_exports__, "k", function() { return src_stack; });
...
/* concated harmony reexport timeFormat */__webpack_require__.d(__webpack_exports__, "l", function() { return timeFormat; });
...
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14);
...
looker.plugins.visualizations.add({
  ...
  updateAsync: function updateAsync(data, element, config, queryResponse, details, done) {
    ...
    try {
      ...
      var svg = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "j"](element).select("svg").html("").attr("width", "100%").attr("height", "100%");
      ...
      var tooltip = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "j"](".tooltip").style("position", "absolute").style("padding", "5px").style("background-color", "white").style("opacity", 0).style("border-radius", "4px").style("display", "block").style("border", "solid").style("border-color", "lightgrey").style("border-width", ".5px");
      ...
      var mouseover = function mouseover(d) {
        ...
        d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "j"](this).style("opacity", 1);
        console.log("mouseover", d3__WEBPACK_IMPORTED_MODULE_0__[/* mouse */ "g"](this));
      };

      var mouseleave = function mouseleave(d) {
        tooltip.transition().duration(0).style("opacity", 0);
        d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "j"](this).style("opacity", 1);
        console.log("mouseleave", d3__WEBPACK_IMPORTED_MODULE_0__[/* mouse */ "g"](this));
      };
      ...
      var mousemove = function mousemove() {
        ...
        if (d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageY < boundedHeight * .7) {
          console.log("here less");
          tooltip.style("top", d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageY - 60 + "px");
        } else {
          tooltip.style("top", d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageY - 160 + "px");
        }

        if (d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageX < boundedWidth * .7) {
          tooltip.style("left", d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageX + 10 + "px");
        } else {
          tooltip.style("left", d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "c"].pageX - 170 + "px");
        }

        console.log("tooltip1");
        tooltipHeader.html("".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* timeFormat */ "l"]("%b'%-y")(data.month), "<hr>"));
        tooltipBody.html("<span style=\"float:left;\">Actual:&nbsp&nbsp</span>" + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](config.metric_format)(data["actual"]), "</span><br>") + "<span style=\"float:left;\">Actual-Contract:&nbsp&nbsp</span>" + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](config.metric_format)(data["actualContract"]), "</span><br>") + "<span style=\"float:left;\">Actual-Spot:&nbsp&nbsp</span>" + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](config.metric_format)(data["actualSpot"]), "</span><br>") + "<span style=\"float:left;\">Budget:&nbsp&nbsp</span>" + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](config.metric_format)(data["budget"]), "</span><br>") + "<span style=\"float:left;\">% to Budget:&nbsp&nbsp</span>" + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](",.0%")(data["actual"] / data["budget"]), "</span><br>") + "<span style=\"float:left;\">Forecast:&nbsp&nbsp</span>" + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](config.metric_format)(data["forecast"]), "</span><br>") + "<span style=\"float:left;\">% to Forecast:&nbsp&nbsp</span>" + "<span style=\"float:right;\">".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](",.0%")(data["actual"] / data["forecast"]), "</span>"));
      ...
      var budgetAccessor = function budgetAccessor(d) {
        return d.budget;
      };

      var forecastAccessor = function forecastAccessor(d) {
        return d.forecast;
      };
      ...
      var actualContractAccessor = function actualContractAccessor(d) {
        return d.actualContract;
      };

      var actualSpotAccessor = function actualSpotAccessor(d) {
        return d.actualSpot;
      ...
      var indexOneMonthAgo = uniqueMonths.indexOf(+currentMonth) - 1;
      var indexFourMonthsAgo = uniqueMonths.indexOf(+currentMonth) - 4;
      var firstMonth = new Date(uniqueMonths[indexFourMonthsAgo]);
      var lastMonth = new Date(uniqueMonths[indexOneMonthAgo]); // const firstWeek = data_ready.filter(element => element.day.getTime() === new Date(new Date(new Date().getFullYear(), new Date().getMonth(), 1).setHours(0,0,0,0)).getTime())[0]['week']

      data_ready = data_ready.filter(function (element) {
        var monthDate = element.month;
      ...
      console.log("data_ready filtered", data_ready); // get all unique values along x axis for xScale calculations
      ...
      var data_stacked = d3__WEBPACK_IMPORTED_MODULE_0__[/* stack */ "k"]().keys(subgroups)(data_ready);
      ...
      var xScale = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleBand */ "h"]().domain(groups).range([0, boundedWidth]).padding(.15);
      var xAxisGenerator = d3__WEBPACK_IMPORTED_MODULE_0__[/* axisBottom */ "a"]().scale(xScale).tickPadding(10).tickSize(0).tickFormat(function (d, i) {
        return "".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* timeFormat */ "l"]("%b'%-y")(d));
      });
      var xAxis = group.append('g').call(xAxisGenerator).style("transform", "translateY(".concat(boundedHeight, "px)")).attr("class", "x-axis"); // Y-AXIS

      var yScale = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleLinear */ "i"]().range([boundedHeight, 0]);

      if (config.budgetlines) {
        yScale.domain([0, Math.max(d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "f"](data_ready, function (d) {
          return actualAccessor(d);
        }), d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "f"](data_ready, function (d) {
          return budgetAccessor(d);
        }), d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "f"](data_ready, function (d) {
          return forecastAccessor(d);
        }))]);
      } else {
        yScale.domain([0, Math.max(d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "f"](data_ready, function (d) {
          return actualAccessor(d);
      ...
      var yAxisGenerator = d3__WEBPACK_IMPORTED_MODULE_0__[/* axisLeft */ "b"]().scale(yScale).tickPadding(10).ticks(6);

      if (config.yticklabels_show) {
        yAxisGenerator.tickFormat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](config.ytick_format));
      } else {
      ...
      var bars = biggroup.selectAll('g .subgroupbars').data(data_stacked).enter().append('g').attr("class", "subgroupbars");
      var stacks = bars.selectAll("rect .stack").data(function (d) {
        ...
        if (config.comparison === "budget") {
          ...
          if (+d.data.actual < +d.data.forecast) {
            return "#D76106";
          } else {
            return "#0072B5";
          }
      ...
      var monthGroups = group.append("g").attr("class", "month-groups").selectAll("g").data(data_ready).enter().append("g").attr("class", function (d) {
        return "singlemonth ".concat(d3__WEBPACK_IMPORTED_MODULE_0__[/* timeFormat */ "l"]("%b'%-y")(monthAccessor(d)));
      }); // const toGoal = monthGroups
      //     .append("text")
      ...
      var comps = monthGroups.append("rect").attr("x", function (d) {
        return xScale(monthAccessor(d)) - 0.04 * xScale.bandwidth();
      }).attr("y", function (d) {
        return yScale(forecastAccessor(d));
      }).attr("width", xScale.bandwidth() + 0.08 * xScale.bandwidth()).attr("height", 4).attr("fill", "lightgrey").attr("stroke", "black").attr("stroke-width", 1);

      if (config.budgetlines) {
        var budgetGoalLine = monthGroups.append("rect").attr("x", function (d) {
          return xScale(monthAccessor(d)) - 0.04 * xScale.bandwidth();
        }).attr("y", function (d) {
          return yScale(budgetAccessor(d));
        }).attr("width", xScale.bandwidth() + 0.08 * xScale.bandwidth()).attr("height", 4).attr("fill", "black");
      }

      var hoverWeekBars = monthGroups.append("rect").attr("x", function (d) {
        return xScale(monthAccessor(d));
      ...
      }).on("mouseleave", mouseleave); // legend

      var legendContainer = group.append("g").attr("transform", "translate(0,0)").classed("legendContainer", true);
      var legendForecast = legendContainer.append('g').classed("legend", true).attr("transform", "translate(6, -30)");
      legendForecast.append("text").attr("x", 20).attr("y", 0).style("text-anchor", "start").style("dominant-baseline", "middle").style("font-size", 11).text("Forecast");
      legendForecast.append("rect").attr("x", 0).attr("y", -3).attr("width", 15).attr("height", 4).attr("fill", "lightgrey").attr("stroke", "black").attr("stroke-width", 1);

      if (config.budgetlines) {
        var legendBudget = legendContainer.append('g').classed("legend", true).attr("transform", "translate(90, -30)");
        legendBudget.append("text").attr("x", 20).attr("y", 0).style("text-anchor", "start").style("dominant-baseline", "middle").style("font-size", 11).text("Budget");
        legendBudget.append("rect").attr("x", 0).attr("y", -2).attr("width", 15).attr("height", 4).attr("fill", "black");
      }
    } catch (error) {
      if (environment == "prod") {
