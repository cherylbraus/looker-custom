...
/* concated harmony reexport max */__webpack_require__.d(__webpack_exports__, "h", function() { return src_max; });
/* unused concated harmony import mean */
/* unused concated harmony import median */
/* unused concated harmony import merge */
/* concated harmony reexport min */__webpack_require__.d(__webpack_exports__, "i", function() { return src_min; });
...
/* concated harmony reexport axisBottom */__webpack_require__.d(__webpack_exports__, "a", function() { return axisBottom; });
/* concated harmony reexport axisLeft */__webpack_require__.d(__webpack_exports__, "b", function() { return axisLeft; });
...
/* concated harmony reexport json */__webpack_require__.d(__webpack_exports__, "g", function() { return json; });
...
/* concated harmony reexport format */__webpack_require__.d(__webpack_exports__, "d", function() { return defaultLocale_format; });
...
/* concated harmony reexport scaleBand */__webpack_require__.d(__webpack_exports__, "j", function() { return band; });
/* unused concated harmony import scalePoint */
/* unused concated harmony import scaleIdentity */
/* concated harmony reexport scaleLinear */__webpack_require__.d(__webpack_exports__, "k", function() { return linear_linear; });
...
/* unused concated harmony import scaleTime */
...
/* unused concated harmony import schemeTableau10 */
...
/* concated harmony reexport interpolateBlues */__webpack_require__.d(__webpack_exports__, "e", function() { return Blues; });
...
/* concated harmony reexport interpolateOranges */__webpack_require__.d(__webpack_exports__, "f", function() { return Oranges; });
/* unused concated harmony import schemeOranges */
/* unused concated harmony import interpolateCividis */
...
/* unused concated harmony import interpolateTurbo */
...
/* concated harmony reexport select */__webpack_require__.d(__webpack_exports__, "l", function() { return src_select; });
...
/* concated harmony reexport event */__webpack_require__.d(__webpack_exports__, "c", function() { return on_event; });
...
/* concated harmony reexport stack */__webpack_require__.d(__webpack_exports__, "m", function() { return src_stack; });
...
// EXTERNAL MODULE: ./node_modules/d3/index.js + 278 modules
var d3 = __webpack_require__(0);

// EXTERNAL MODULE: ./node_modules/d3-collection/src/index.js + 6 modules
var src = __webpack_require__(1);

// EXTERNAL MODULE: ./src/integration/common/utils.ts
...
var object = {
  ...
  updateAsync: function updateAsync(data, element, config, queryResponse, details, done) {
    ...
    if (environment == "prod") {
      if (!Object(utils["a" /* handleErrors */])(this, queryResponse, {
        min_pivots: 0,
        max_pivots: 0,
        min_dimensions: 0,
        max_dimensions: 22,
    ...
    try {
      // DRAW DATA ---------------------------------------------------
      var colorDivider = function colorDivider(len) {
        return 0.5 / (len - 1);
      };

      var mousemove = function mousemove(d) {
        var subgroupNameNumber = d3["l" /* select */](this.parentNode).datum().key;
        var subgroupValue = d.data[subgroupNameNumber]; // console.log("subgroupInfo", subgroupNameNumber, subgroupValue, d.data)

        var measureIndex = subgroupNameNumber.split("-")[1];
        var measureSide = subgroupNameNumber.split("-")[0];
        var measureName = measures[measureIndex].label_short || measures[measureIndex].label;
        ...
        var totalKey = d.data["leftTot"] ? "leftTot" : "rightTot";
        console.log("totalKey", totalKey);
        tooltipHeader.html("".concat(Object.keys(ytickMapping).find(function (key) {
          return ytickMapping[key] === d.data.label;
        }) || d.data.label, "<hr>"));
        tooltipBody.html("<span style=\"float:left;\">".concat(measureName, ":&nbsp&nbsp</span>") + "<span style=\"float:right;\">".concat(d3["d" /* format */](config.x_format)(subgroupValue * valueSign), "</span><br>") + "<span style=\"float:left;\">% of Total:&nbsp&nbsp</span>" + "<span style=\"float:right;\">".concat(d3["d" /* format */](",.1%")(subgroupValue / d.data[totalKey]), "</span>"));

        if (totalKey == "rightTot" && config.right_hovers) {
          var data_row = data.filter(function (f, i) {
            return f[dimensions[0].name].value === d.data.label;
          });
          var rightHovers = [];
          var rightHoverItems = config.right_hovers.split(",");
          rightHoverItems.forEach(function (d) {
            return rightHovers.push(+d);
          });
          var right_add = "<br>";
          rightHovers.forEach(function (d, i) {
            var tmp = "<br><span style=\"float:left;\">".concat(measures[d].label_short, ":&nbsp&nbsp</span>") + "<span style=\"float:right;\">".concat(d3["d" /* format */](",.0f")(data_row[0][measures[d].name].value), "</span>");
            right_add = right_add + tmp;
          });
          tooltipBody.html(tooltipBody.html() + right_add);
        }

        if (totalKey == "leftTot" && config.left_hovers) {
          var _data_row = data.filter(function (f, i) {
            return f[dimensions[0].name].value === d.data.label;
          });

          var leftHovers = [];
          var leftHoverItems = config.left_hovers.split(",");
          leftHoverItems.forEach(function (d) {
            return leftHovers.push(+d);
          });
          var left_add = "<br>";
          leftHovers.forEach(function (d, i) {
            var tmp = "<br><span style=\"float:left;\">".concat(measures[d].label_short, ":&nbsp&nbsp</span>") + "<span style=\"float:right;\">".concat(d3["d" /* format */](",.0f")(_data_row[0][measures[d].name].value), "</span>");
            left_add = left_add + tmp;
          });
          tooltipBody.html(tooltipBody.html() + left_add);
        }

        if (d3["c" /* event */].pageY < boundedHeight * 0.7) {
          tooltip.style("top", d3["c" /* event */].pageY - 40 + "px");
        } else {
          tooltip.style("top", d3["c" /* event */].pageY - 150 + "px");
        }

        if (d3["c" /* event */].pageX < boundedWidth * 0.7) {
          tooltip.style("left", d3["c" /* event */].pageX + 20 + "px");
        } else {
          tooltip.style("left", d3["c" /* event */].pageX - 170 + "px");
        }
      };
      ...
      var svg = d3["l" /* select */](element).select("svg").html('').attr('width', '100%').attr('height', '100%');
      var group = svg.append('g').attr("transform", "translate(".concat(margin.left, ",").concat(margin.top, ")")).attr("width", "100%").attr("height", boundedHeight + "px").classed("group", true); // determine rights and lefts --------------------------

      var rightCols = [];
      var leftCols = [];

      if (config.right_measures) {
        var rightItems = config.right_measures.split(",");
        rightItems.forEach(function (d) {
          return rightCols.push(+d);
        });
      } else {
        rightCols.push(0);
      }
      ...
      if (config.left_measures) {
        var leftItems = config.left_measures.split(",");
        leftItems.forEach(function (d) {
          return leftCols.push(+d);
        });
      } else {
        leftCols.push(1);
      }

      console.log("right/left cols", rightCols, leftCols); // format data -----------------------------------------
      ...
      data.forEach(function (d) {
        ...
        entry['rightTot'] = 0;
        rightCols.forEach(function (ind) {
          entry["right-".concat(ind)] = +d[measures[ind].name].value;
          entry['rightTot'] += +d[measures[ind].name].value;
          rightSubgroups.push("right-".concat(ind));
        });
        data_right.push(entry);
      });
      var data_left = [];
      var leftSubgroups = [];
      var leftSign = config.left_negative == "true" ? 1 : -1;
      data.forEach(function (d) {
        var entry = {};
        entry['label'] = d[dimensions[0].name].value;
        entry['leftTot'] = 0;
        leftCols.forEach(function (ind) {
          entry["left-".concat(ind)] = leftSign * +d[measures[ind].name].value;
          entry['leftTot'] += leftSign * +d[measures[ind].name].value;
          leftSubgroups.push("left-".concat(ind));
        });
      ...
      var labelAccessor = function labelAccessor(d) {
        return d.label;
      };

      var righttotAccessor = function righttotAccessor(d) {
        return d.rightTot;
      };

      var lefttotAccessor = function lefttotAccessor(d) {
        return d.leftTot;
      }; // setup subgroups and groups ----------------------------------
      // subgroups = the stacked sections in the bars


      rightSubgroups = _toConsumableArray(new Set(rightSubgroups));
      leftSubgroups = _toConsumableArray(new Set(leftSubgroups));
      console.log("subgroups", rightSubgroups, leftSubgroups);
      var rightStacked = d3["m" /* stack */]().keys(rightSubgroups)(data_right);
      var leftStacked = d3["m" /* stack */]().keys(leftSubgroups)(data_left);
      console.log("rightstacked", rightStacked);
      console.log("leftstacked", leftStacked); // sort data ---------------------------------------------------
      ...
      data_left.sort(function (a, b) {
        return +b.left - +a.left;
      });
      var yValues = data.map(function (d) {
        return d[dimensions[0].name].value;
      });
      var yValuesArray = [];
      yValues.forEach(function (d, i) {
        var entry = {};
        entry['label'] = d;
        var filterdata = data_left.filter(function (f, i) {
          return f.label === d;
        });
      ...
      yValuesArray.sort(function (a, b) {
        return +b.leftTot - +a.leftTot;
      });
      var yValuesOrderedActual = yValuesArray.map(function (d) {
        return d.label;
      });
      var yValuesOrdered;
      var ytickMapping = {};
      ...
      if (config.y_ticklabels) {
        ...
        for (var i = 0; i < yValuesOrderedActual.length; i++) {
      ...
      console.log("ytickmapping", ytickMapping); // AXES ---------------------------------------------------  

      var yScale = d3["j" /* scaleBand */]() // .domain(data_ready.map(d => labelAccessor(d)))
      .domain(yValuesOrdered).range([boundedHeight, 0]).padding(0.2);
      console.log("yScale", yScale.domain(), yScale.range());
      var yAxisGenerator = d3["b" /* axisLeft */]().scale(yScale).tickPadding(10).tickSize(0); // .tickFormat((d) => `${d}`)

      var xScaleDomain = [d3["i" /* min */](data_left.map(function (d) {
        return d.leftTot;
      })), d3["h" /* max */](data_right.map(function (d) {
        return d.rightTot;
      }))];
      var xScale = d3["k" /* scaleLinear */]().domain(xScaleDomain).range([0, boundedWidth]);
      var xAxisGenerator = d3["a" /* axisBottom */]().scale(xScale).tickPadding(10).tickSizeOuter(0) // .tickSizeInner(5)
      .tickSizeInner(-boundedHeight);

      if (config.left_negative == "false") {
        xAxisGenerator.tickFormat(function (d) {
          return d3["d" /* format */](config.x_format)(Math.abs(d));
        });
      } else {
        xAxisGenerator.tickFormat(function (d) {
          return d3["d" /* format */](config.x_format)(d);
        });
      }
      ...
      var left_color_divider = colorDivider(leftCols.length);
      var right_color_divider = colorDivider(rightCols.length);
      var left_colors = [];
      var right_colors = [];
      console.log("color_dividers", left_color_divider, right_color_divider);
      var barsLeft = group.append("g").selectAll("g").data(leftStacked).enter().append("g").attr("fill", function (e, i) {
        if (i == 0) {
          var color = d3["f" /* interpolateOranges */](.5);
          left_colors.push(color);
          return color;
        } else {
          var _color = d3["f" /* interpolateOranges */](left_color_divider * i + 0.5);

          left_colors.push(_color);
          return _color;
        }
        ...
        return yScale(Object.keys(ytickMapping).find(function (key) {
          return ytickMapping[key] === d.data.label;
        }) || d.data.label);
      }).attr("height", yScale.bandwidth()).attr("width", function (d) {
        return xScale(d[0]) - xScale(d[1]);
      }).classed("left-bar", true).on("mousemove", mousemove).on("mouseout", mouseout);
      var barsRight = group.append("g").selectAll("g").data(rightStacked).enter().append("g").attr("fill", function (e, i) {
        if (i == 0) {
          var color = d3["e" /* interpolateBlues */](.5);
          right_colors.push(color);
          return color;
        } else {
          var _color2 = d3["e" /* interpolateBlues */](right_color_divider * i + 0.5);

          right_colors.push(_color2);
          return _color2;
        }
      }).selectAll("rect").data(function (d) {
        return d;
      ...
      }).classed("right-bar", true).on("mousemove", mousemove).on("mouseout", mouseout); // Y AXIS TICK TEXT -----------------------------------------

      var yAxisTickTexts = group.append("g").attr("transform", "translate(".concat(xScale(0), ",0)")).call(yAxisGenerator).call(function (g) {
        return g.selectAll(".tick text").attr("dx", -8).attr("x", function (y) {
          if (config.y_ticklabels) {
            var rowData = data_left.filter(function (d, i) {
              return d.label = ytickMapping[y];
            });
            return xScale(rowData[0].leftTot) - xScale(0);
          } else {
            var _rowData = data_left.filter(function (d, i) {
              return d.label == y;
            });

            return xScale(_rowData[0].leftTot) - xScale(0);
          }
        });
      });
      yAxisGenerator.tickFormat("");
      var yAxis = group.append("g").call(yAxisGenerator).attr("class", "y-axis");
      var yAxisLabel = yAxis.append("text").attr("class", "axis-label").attr("x", -boundedHeight / 2).attr("y", -margin.left + 13).style("transform", "rotate(-90deg)").text(config.y_label ? config.y_label : dimensions[0].label);

      if (config.show_xlabel == "true") {
        var xAxisLabel = xAxis.append("text").attr("class", "axis-label").attr("x", xScale(0)).attr("y", margin.bottom - 8).style("text-anchor", "middle").text(config.x_label);
      } // LEGEND --------------------------------------------------


      var colors = left_colors.reverse().concat(right_colors);
      var cols = leftCols.reverse().concat(rightCols);
      console.log("width", width);
      var legend = group.append("g").attr("transform", "translate(".concat(0 - margin.left + 10, ",-35)")).classed("legend", true);
      legend.append("g").classed("legend-0", true);
      legend.append("g").classed("legend-1", true);
      legend.append("g").classed("legend-2", true);
      var legendRows = [d3["l" /* select */]('.legend-0'), d3["l" /* select */]('.legend-1'), d3["l" /* select */]('.legend-2')];
      var rowNum = 0;
      colors.forEach(function (d, i) {
        console.log("begin", rowNum, legendRows[rowNum]);
        var thisRowLegend = legendRows[rowNum];
        var gCoord = thisRowLegend.node().getBBox();
        var height = 12 * rowNum;
        console.log("thisRowLegend", thisRowLegend);
        var start = gCoord.width == 0 ? gCoord.width : gCoord.width + 15;
        ...
        thisRowLegend.append("rect").attr("x", start).attr("y", height - 5).attr("width", 8).attr("height", 8).attr("fill", colors[i]).attr("fill-opacity", 1.0);
        thisRowLegend.append("text").attr("x", start + 12).attr("y", height).style("text-anchor", "start").style("dominant-baseline", "middle").style("font-size", 11).text(measures[cols[i]].label_short || measures[cols[i]].label);
      }); // legend.append("rect")
      //     .attr("x", 0)
      //     .attr("y", -5)
      //     .attr("width", 8)
      ...
      var tooltip = d3["l" /* select */](".tooltip").style("position", "absolute").style("padding", "5px").style("background-color", "white").style("opacity", 0).style("border-radius", "4px").style("display", "block").style("border", "solid").style("border-color", "lightgrey").style("border-width", ".5px").attr("pointer-events", "none").classed("tooltip", true);
...
// CONCATENATED MODULE: ./src/integration/template/template.js
 ...
 //'./heatmap' //asp './sparklinesNew' ./hexmap conwinrate asp cycle
...
var x = 0;
var y = 0; // The dimension of the element
...
keys.forEach(function (entry, i) {
  var array_name = object.options[entry].label;
  ...
  if (["radio", "select"].includes(object.options[entry].display)) {
    var array_values = object.options[entry].values;
    ...
    _str = "<input type='text' internal_cat='" + keys[i] + "' internal_value='" + object.options[entry]["default"] + "' id='" + keys[i] + "' name='" + object.options[entry]["label"] + "' value='" + object.options[entry]["default"] + "'></input><label class='form-label' for='" + object.options[entry]["label"] + "'>" + object.options[entry]["label"] + "</label>";
    form.append(_str);
    ...
    var _array_values2 = object.options[entry]["default"]; // console.log("array_values", array_values)
...
d3["g" /* json */]("http://localhost:3001/dataDivergingAnn").then(function (data) {
  //dataHeatmapTableCalc dataASP dataDivergingSimple dataCycleChart dataConWinRate3 dataMCSmap2 dataSankey2 dataSparklineWorks dataSparklineIH
  var todays_options = {};
  ...
  object.updateAsync(data.data, d3["l" /* select */]("#vis")._groups[0][0], todays_options, data.queryResponse, details, template_done, this_environment); // On change to options, loop through selections and then redraw chart

  jquery('input:radio').on("click", function () {
    jquery('input:radio:checked').each(function () {
      todays_options[this.attributes.internal_cat.value] = this.attributes.internal_value.value;
    });
    object.updateAsync(data.data, d3["l" /* select */]("#vis")._groups[0][0], todays_options, data.queryResponse, details, template_done, this_environment);
  });
  ...
  var mouseDownHandler = function mouseDownHandler(e) {
    ...
    x = e.clientX;
    y = e.clientY; // Calculate the dimension of element
  ...
  var mouseMoveHandler = function mouseMoveHandler(e) {
    ...
    var dx = e.clientX - x;
    var dy = e.clientY - y; // Adjust the dimension of element
...
var formatType = function (valueFormat) {
    ...
    return d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "d"](format);
};
