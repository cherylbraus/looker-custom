...
import { object } from './asp' //asp './sparklinesNew' ./hexmap conwinrate asp cycle
...
d3.json("http://localhost:3001/dataASP").then(function(data) { //dataASP dataDivergingSimple dataCycleChart dataConWinRate3 dataMCSmap2 dataSankey2 dataSparklineWorks dataSparklineIH
	let todays_options = {}
