  ...
  updateAsync: function(data, element, config, queryResponse, details, done, environment = "prod") {
    ...
    try {
        ...
        if (environment == "prod") {
            ...
            this.addError({title: "Dimension/Pivot Error", message: "An error occurred."});
            return;
            } 
        }
    }
